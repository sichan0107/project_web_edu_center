					...
					<div class="mr-auto">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li><a href="index.jsp" class="nav-link text-left">메인</a>
								</li>
	 ...
	 <a href='CourseCheck?command=coursesById&studentId=${sessionScope.student.studentId}' class="nav-link text-left">수강 내역</a>
		...
		<table align="center" border="0" cellpadding="5" cellspacing="2"
			...
			<tr>
				...
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">강의 코드</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">강의명
									</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">시작일</span></b></font>
								...
								<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">종료일</span></b></font>
					</p>
				</td>
			...
			<c:if test="${empty list || fn:length(list) == 0}">
				<tr>
					<td colspan="5">
						<p align="center">
							<b><span style="font-size: 13pt;">등록한 강의가 없습니다.</span></b>
						</p>
					</td>
				</tr>
			</c:if>
			...
			<c:forEach items="${requestScope.list}" var="data">
				<tr>
					...
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;"> ${data.startDay}
							</span>
						</p>
					</td>
										<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;">  ${data.endDay}
							</span>
						</p>
					</td>
				</tr>
		...
		<a href="writeCourse.jsp"
			class="small btn btn-primary px-4 py-2 rounded-0"><span
			class="icon-users"></span>강의 등록하기</a>
			<br>
			<br>
