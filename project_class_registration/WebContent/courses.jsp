	...
	<div class="site-wrap">
						...
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li class="active"><a href="index.jsp"
									class="nav-link text-left">메인</a></li>
								...
								<c:choose>
									<c:when test="${not empty sessionScope.student.studentName}">
										<li> <a href='CourseCheck?command=coursesById&studentId=${sessionScope.student.studentId}' class="nav-link text-left">수강 내역</a></li>
									</c:when>
									<c:when test="${not empty sessionScope.teacher.teacherName}">
										<li><a
		...
		<table align="center" border="0" cellpadding="5" cellspacing="2"
			...
			<tr>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">과목
									코드</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
				...
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">강사명</span></b></font>
					</p>
				</td>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">시작일</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">수강
									여부</span></b></font>
					</p>
				</td>
								<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">삭제하기
									</span></b></font>
					</p>
				</td>
			</tr>
			...
			<c:if test="${empty list || fn:length(list) == 0}">
				<tr>
					<td colspan="5">
						<p align="center">
							<b><span style="font-size: 19pt;">신청한 과목이 없습니다.</span></b>
						</p>
					</td>
				</tr>
			</c:if>
			...
			<c:forEach items="${requestScope.list}" var="data">
				<tr>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;">${data.classCode}</span>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
							<a href="Controller?command=getClass&classCode=${data.classCode}" ><span style="font-size: 13pt;"> ${data.className}</span></a>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;"> ${data.teacherName} </span>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;"> ${data.startDay} </span>
						</p>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;"> ${data.result} </span>
						</p>
					</td>
										<td bgcolor="">
						<p align="center">
							<a href="Controller?command=registrationDelete&studentId=${sessionScope.student.studentId}&classCode=${data.classCode}"><span style="font-size: 13pt;"> 수강 등록 취소 </span></a>
						</p>
					</td>
				</tr>
			</c:forEach>
				...
				<td bgcolor="">
					<p>
						<span style="font-size: 9pt;"><a
							href="ReadAContent.jsp?num= "></a></span>
					</p>
				</td>
				<td bgcolor="">
					<p align="center">
						<span style="font-size: 9pt;"> <a href="mailto:"></a>
						</span>
					</p>
				</td>
				<td bgcolor="">
