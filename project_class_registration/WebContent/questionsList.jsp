					...
					<div class="mr-auto">
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li><a href="about.jsp" class="nav-link text-left">문의보기
										소개</a></li>
                <li>
 ...
 <a href='CourseCheck?command=coursesById&studentId=${sessionScope.student.studentId}' class="nav-link text-left">수강 내역</a>
		...
		<table align="center" border="0" cellpadding="5" cellspacing="2"
			...
			<tr>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">작성자</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">이메일
									</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">문의 내용</span></b></font>
					</p>
				</td>
				<td bgcolor="#336699">
					<p align="center">
						<font color="white"><b><span style="font-size: 13pt;">답변 여부</span></b></font>
					</p>
				</td>
			</tr>
			...
			<c:if test="${empty list || fn:length(list) == 0}">
				<tr>
					<td colspan="5">
						<p align="center">
							<b><span style="font-size: 13pt;">문의 내역이 없습니다.</span></b>
						</p>
					</td>
				</tr>
			</c:if>
			...
			<c:forEach items="${requestScope.list}" var="data">
				<tr>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;"> ${data.name}</span>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;"><a href=malito:${data.email}> 
									${data.email}</a>
							</span>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;">  ${data.content}
							</span>
						</p>
					</td>
					<td bgcolor="">
						<p align="center">
							<span style="font-size: 13pt;">  미답변
							</span>
						</p>
					</td>
				</tr>
