...
<c:choose>
	...
	<center>
				<c:choose>
					<c:when test="${not empty requestScope.studentId}">
						<h2>${requestScope.studentId}님의가입을 축하합니다.</h2>
					</c:when>
					<c:when test="${not empty requestScope.teacherId}">
						<h2>${requestScope.teacherId}님의가입을 축하합니다.</h2>
					</c:when>
				</c:choose>

				<br> <br> <br> <a href="index.jsp">메인 화면으로 이동하기</a> <br>
				<br> <br> <br> <br>
				</center>
		</div>
