...
<c:choose>
	<c:when test="${not empty sessionScope.teacher}">
          <span class="icon-unlock-alt"></span>${sessionScope.teacher}
	...
	<c:when test="${not empty sessionScope.student}">
 		<span class="icon-unlock-alt"></span>${sessionScope.student}
		<a href="Logout" class="small btn btn-primary px-4 py-2 rounded-0"><span class="icon-users"></span>로그아웃</a>
	</c:when>
	<c:otherwise>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="mr-auto">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                  <a href="admissions.jsp class="nav-link text-left">수강 신청</a>
                </li>
                <li>
                  <a href="courses.jsp" class="nav-link text-left">수강 내역</a>
                </li>
                <li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">엔코아 강사 소개</h2>
              <p>우수한 엔코아 강사들을 만나보세요.</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <a href="admissions.jsp">교육센터 소개</a>
        <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current">강사 소개</span>
      </div>
    </div>
