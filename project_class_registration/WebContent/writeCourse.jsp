...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<div class="site-wrap">
		...
		<div class="custom-breadcrumns border-bottom">
			<div class="container">
				<a href="index.jsp">메인</a> <span
					...
					href="admissions.html">나의 강의</a> <span
					class="mx-3 icon-keyboard_arrow_right"></span> <span
					class="current">강의 추가하기</span>
			</div>
		</div>
		<br> <br> <br> <br> <br>
		...
		<form name="writeForm" method="post"
			action="Controller?command=createClass"
			...
			<table align="center" cellpadding="5" cellspacing="2" width="600"
				...
				<tr>
					<td width="1220" height="20" colspan="2" bgcolor="#336699">
						<p align="center">
							<font color="white" size="3"><b>강의 추가하기</b></font>
						</p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">과목 금액</span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <input type=text
								name="classPrice" size="30"></span></b></td>
				</tr>
				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">과목명</span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <input type=text name="className"
								size="30"></span></b></td>
				</tr>
				<tr>
					<td width="150" height="20">
					...
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <input type=text name="classTime"
								size="30"></span></b></td>
				</tr>
				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">강사명</span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <input type=text
								name="teacherName" value="${sessionScope.teacher.teacherName}"
								size="30" readonly></span></b></td>
				</tr>
				...
				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">시작일 </span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <input type=text id="datepicker"
								name="startDay" size="30"></span></b></td>
				</tr>
				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">종료일</span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <input type=text id="datepicker1"
								name="endDay" size="30"></span></b></td>
				</tr>

				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">소 주제</span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <textarea name="simpleIntro"
									cols="50" rows="10"></textarea></span></b></td>
				</tr>
				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">과목소개</span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <textarea name="detailIntro"
									cols="50" rows="10"></textarea></span></b></td>
				</tr>
				<tr>
					<td width="150" height="20">
						<p align="right">
							<b><span style="font-size: 9pt;">제한인원</span></b>
						</p>
					</td>
					<td width="450" height="20"><b><span
							style="font-size: 9pt;"> <input type=text
								name="maxStudent" size="30"></span></b></td>
				</tr>
		...
		<hr>
		<div align=right>
			<span style="font-size: 20pt;">&lt;<a
				href='CourseCheck?command=courseList&teacherName=${sessionScope.teacher.teacherName}'>리스트로
					돌아가기</a>&gt;
			</span>
		</div>
